      ...
      <section className="py-32">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <Link to="/expertises#droit-des-societes" className="group p-8 bg-white hover:bg-gray-50 transition-all duration-500 border border-gray-100 block">
            ...
            <Link to="/expertises#droits-actifs-numeriques" className="group p-8 bg-white hover:bg-gray-50 transition-all duration-500 border border-gray-100 block">
            ...
            <Link to="/expertises#droit-conso-distribution" className="group p-8 bg-white hover:bg-gray-50 transition-all duration-500 border border-gray-100 block">
            ...
            <Link to="/expertises#droit-construction-risques-industriels" className="group p-8 bg-white hover:bg-gray-50 transition-all duration-500 border border-gray-100 block">
            ...
            <Link to="/expertises#modes-alternatifs-reglement-litiges" className="group p-8 bg-white hover:bg-gray-50 transition-all duration-500 border border-gray-100 block">
